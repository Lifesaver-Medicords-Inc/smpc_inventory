...
{
    public partial class frm_item_type_setup : UserControl
    {
        public frm_item_type_setup()
        {
            InitializeComponent();
        }
        ...
        private async void frm_item_type_setup_Load(object sender, EventArgs e)
        {
            GetData();
        ...
        private void dg_item_type_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            DataTable dt = Helpers.ConvertDataGridViewToDataTable(dg_item_type);
