...
{  class Bpi
    ...
    class BpiContacts
    {
        ...
        public BpiContacts (int contactId , int contact_based_id ,string number , string name , string email ,string preferences, int positions ,int branchId)
        {
    ...
    class BpiAddress
    {
        ...
        public BpiAddress(int  addressId, int addressBasedId, string location, int branchId)
        {
    ...
    class BpiAccreditation
    {
        ...
        public int accreditation_added_by_id { get; set; }

        public BpiAccreditation(int bpiAccreditationId, int bpiAccreditationBranchId, string dateAdded, string filePath, int accreditationAddedById , int bpiAccreditationBasedId, string fileName)
        {
           ...
           this.bpi_accreditation_branch_id = bpiAccreditationBranchId;
            ...
            this.accreditation_added_by_id = accreditationAddedById;
        }
    ...
    class BpiItems
    {
        ...
        public BpiItems(int bpi_item_id , int bpi_item_based_id, int paymentTermsId, int itemId,string taxCode, string item_tax_code, float price, string notes, int itemAccountId)
        {
