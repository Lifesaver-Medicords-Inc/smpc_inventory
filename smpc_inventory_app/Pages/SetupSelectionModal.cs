...
{
    internal partial class SetupSelectionModal : Form
    {
        ...
        internal SetupSelectionModal(string title, string api, DataTable dt, List<int> currentValues, List<string> currentGridValues, int recordIndex )
        {
            InitializeComponent();
