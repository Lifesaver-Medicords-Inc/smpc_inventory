namespace smpc_inventory_app.Pages.Inventory
{
    partial class ItemStocksPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btn_adjust
            // 
            this.btn_adjust.Location = new System.Drawing.Point(695, 9);
            ...
            // btn_transfer
            // 
            this.btn_transfer.Location = new System.Drawing.Point(811, 9);
            ...
            // btn_add
            // 
            this.btn_add.Location = new System.Drawing.Point(595, 9);
            ...
            // btn_refresh
            // 
            this.btn_refresh.Location = new System.Drawing.Point(510, 9);
            ...
            // txt_search
            // 
            this.txt_search.Location = new System.Drawing.Point(280, 11);
            ...
            this.lbl_search.Location = new System.Drawing.Point(230, 14);
            ...
            this.lbl_title.Size = new System.Drawing.Size(192, 20);
            this.lbl_title.TabIndex = 0;
            this.lbl_title.Text = "INVENTORY ITEM STOCKS";
            //
            // dgv_item_stocks
            //
            // Was relying on AutoGenerateColumns (the default), which would show every
            // public property on ItemStockModel - including the raw id/item_id/
            // warehouse_id int columns - with the literal property name as the header
            // (e.g. "item_code", not "Item Code"). Wiring up the columns explicitly
            // (col_item_code etc. were already declared below, just never actually
            // added anywhere) makes the header text and column set deterministic, and
            // is where the new col_item_model (Model) column goes in, right after Item
            // Name to match the CODE/COMPONENTS/MODEL ordering used elsewhere in this
            // app (e.g. the BOM screen's own item picker).
            ...
            // col_item_model
            //
            this.col_item_model.DataPropertyName = "item_model";
