...
{
    public partial class PurchaseRequisitionCard : UserControl
    {
        ...
        public PurchaseRequisitionCard(int id, string orderNo, string projectName, string commitmentDate, string purchaser, int numberOfItems, string itemNames, string customer)
        {
            InitializeComponent();
        ...
        public void UpdateDetails(string orderNo, string projectName, string commitmentDate, string purchaser, int numberOfItems, string itemNames, string customer)
        {
            ...
            lbl_document_no.Text = "PR#" + OrderNo;
        ...
        private void PurchaseRequisitionCard_Load(object sender, EventArgs e)
        {
        ...
        private async Task checkBox1_CheckedChangedAsync()
        {
            ...
            var message = checkBox1.Checked ? "Purchase Requisition has been reserved" : "Purchase Requisition reservation has been removed";
            ...
            try
            {
                ApiResponseModel response = await PurchasingRedboxListServices.UpdatePurchaseRequisition(data);

                if (response != null && response.Success)
                {
                    Purchaser = newPurchaser;
                    UpdateDetails(OrderNo, ProjectName, CommitmentDate, Purchaser, NumberOfItems, ItemNames, Customer);
        ...
        private void btn_view_details_Click(object sender, EventArgs e)
        {
            ...
            {
                string orderNo = !string.IsNullOrWhiteSpace(OrderNo) ? "PR#" + OrderNo.Split(',')[0] : "N/A";
