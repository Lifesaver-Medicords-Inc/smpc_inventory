...
{
    public partial class frm_item_class_setup : UserControl
    { 
        public frm_item_class_setup()
        {
            InitializeComponent();
        }
        private async void GetData()
        {
            var data = await ItemClassServices.GetAsDatatable();
            dg_item_class.DataSource = data;
        }
        private void frm_item_class_setup_Load(object sender, EventArgs e)
        {
            GetData();
        ...
        private async void btn_save_Click(object sender, EventArgs e)
        {
            ...
            response = isNewRecord
                ? await ItemClassServices.Insert(data)
                : await ItemClassServices.Update(data);
        ...
        private void dg_item_class_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex < 0) return;
            Panel[] pnlList = { pnl_input };
            DataTable dt = Helpers.ConvertDataGridViewToDataTable(dg_item_class);
        ...
        private void BtnToggle(bool isEdit)
        {
            ...
            dg_item_class.Enabled = !isEdit;
        }

        private void btn_edit_Click(object sender, EventArgs e)
        {
            BtnToggle(true);
            dg_item_class.ClearSelection();
        }
