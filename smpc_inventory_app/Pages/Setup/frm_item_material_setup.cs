...
{
    public partial class frm_item_material_setup : UserControl
    {
        public frm_item_material_setup()
        {
            InitializeComponent();
        }
        private async void GetData()
        {
            var data = await ItemMaterialServices.GetAsDatatable();
            dg_item_material.DataSource = data;
        }

        private void frm_item_material_setup_Load(object sender, EventArgs e)
        {
            GetData();
        ...
        private async void btn_save_Click(object sender, EventArgs e)
        {
            ...
            response = isNewRecord
                ? await ItemMaterialServices.Insert(data)
                : await ItemMaterialServices.Update(data);
        ...
        private void dg_item_material_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex < 0) return;
            Panel[] pnlList = { pnl_input };
            DataTable dt = Helpers.ConvertDataGridViewToDataTable(dg_item_material);
        ...
        private void BtnToggle(bool isEdit)
        {
            ...
            dg_item_material.Enabled = !isEdit;
        }
        ...
        private void btn_new_Click(object sender, EventArgs e)
        {
            Helpers.ResetControls(pnl_input);
            BtnToggle(true);
            dg_item_material.ClearSelection();
        }
        ...
        private async void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                bool isSuccess = await ItemMaterialServices.Delete(data);
